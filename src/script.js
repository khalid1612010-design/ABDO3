...
const CONFIG = {
  ...
  email: "contact@elmahroky-law.com",
};
...
const translations = {
  ar: {
    meta: {
      title: "عبدالله سيد المحركي | محامي متخصص",
      description:
        "المحامي عبدالله سيد المحركي - متخصص في القضايا المدنية والجنائية وتأسيس الشركات والاستشارات القانونية.",
    },
    nav: {
      home: "الرئيسية",
      about: "من نحن",
    ...
    about: {
      ...
      paragraphs: [
        "المحامي عبدالله سيد المحركي يمتلك أكثر من خمس سنوات من الخبرة العملية في مجال القانون، حيث قدم استشارات قانونية متخصصة لعدد من الشركات والأفراد في مختلف المجالات.",
      ...
      items: [
        {
          ...
          period: "حتى الآن",
          description:
            "تقديم الاستشارات القانونية الشاملة، مراجعة العقود، وضمان الالتزام القانوني للشركات.",
        },
        {
          role: "محامٍ متخصص",
          company: "مكاتب محاماة مرموقة",
          period: "سنوات سابقة",
          description:
            "المشاركة في إدارة القضايا المدنية والجنائية وتقديم الدفاع القانوني أمام المحاكم المصرية.",
        },
        {
          role: "العمل القانوني المؤسسي",
          company: "قطاع الأعمال",
          period: "خبرة متراكمة",
          description:
            "العمل على تأسيس الشركات، إصدار التراخيص، ومتابعة الإجراءات الحكومية لدى الجهات المعنية.",
        },
      ],
    },
    whyUs: {
  ...
  en: {
    meta: {
      title: "Abdullah Sayed Elmahroky | Specialized Lawyer",
      description:
        "Lawyer Abdullah Sayed Elmahroky - specialized in civil, criminal, and corporate law, company formation, and legal consultation.",
    },
    nav: {
      home: "Home",
      about: "About",
    ...
    about: {
      ...
      paragraphs: [
        "Lawyer Abdullah Sayed Elmahroky has more than five years of practical experience in the legal field, providing specialized legal consultations to a number of companies and individuals across various sectors.",
      ...
      items: [
        {
          ...
          period: "Present",
          description:
            "Providing comprehensive legal consultations, reviewing contracts, and ensuring corporate legal compliance.",
        },
        {
          role: "Specialized Lawyer",
          company: "Reputable Law Firms",
          period: "Previous Years",
          description:
            "Participating in managing civil and criminal cases and providing legal defense before Egyptian courts.",
        },
        {
          role: "Corporate Legal Work",
          company: "Business Sector",
          period: "Cumulative Experience",
          description:
            "Working on company establishment, licensing, and following up on government procedures with relevant authorities.",
        },
      ],
    },
    whyUs: {
