...
const translations = {
  ar: {
    meta: {
      title: "عبدالله سيد الحروق | محامي متخصص",
      description:
        "المحامي عبدالله سيد الحروق - متخصص في القضايا المدنية والجنائية وتأسيس الشركات والاستشارات القانونية.",
    },
    nav: {
      home: "الرئيسية",
      about: "من نحن",
    ...
    about: {
      ...
      paragraphs: [
        "المحامي عبدالله سيد الحروق يمتلك أكثر من خمس سنوات من الخبرة العملية في مجال القانون، حيث قدم استشارات قانونية متخصصة لعدد من الشركات والأفراد في مختلف المجالات.",
